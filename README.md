...
| `ID_MANAGER_CONFIG`         | JSON string containing configuration options for external ID Manager integration. This is used when integrating with an external ID management service.                                                                                                                                              |                                        |
| `ID_MANAGER_SECRET`         | Secret token or API key required to authenticate with the external ID Manager service.                                                                                                                                                                                                               |                                        |
